      ...
      <div className="w-full max-w-[560px] rounded-2xl border border-[#e7edf5] bg-white p-6 shadow-2xl">
        <div className="mb-4 flex items-start justify-between gap-4">
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full px-2 py-1 text-[12px] text-[#98a2b3] hover:bg-[#f4f7fb]"
          >
            关闭
          </button>
        </div>
        ...
        <div className="mt-6 flex flex-wrap justify-end gap-3">
          ...
          {needService ? (
            <button
              type="button"
              className="rounded-lg border border-[#f6a26e] px-4 py-2 text-[13px] font-semibold text-[#c2410c]"
            >
              联系客服
            </button>
          ) : null}
