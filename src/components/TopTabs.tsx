...
export default function TopTabs({ activeTab, onSelect }: TopTabsProps) {
  return (
    <div className="soft-scrollbar flex h-[56px] items-end gap-10 overflow-x-auto rounded-xl border border-[#e5ebf3] border-b border-[#e7edf5] bg-white px-8 shadow-sm">
      {tabs.map((tab) => (
        <button
          key={tab.key}
          type="button"
